...
function verProducto(seleccionado) {
    ...
    var stock = rowData['stock_minimo'];
    var dimension = rowData['dimension'];
    var unidad_m = rowData['unidad_medida'];
    ...
    $('#ver_stock').val(stock);
    $('#ver_dimension').val(dimension);
    $('#ver_unidad_medida').val(unidad_m);

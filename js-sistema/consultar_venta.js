...
function get_note_sales_adm() {
    $('#lista_nota_adm').DataTable({
        ...
        'ajax': {
            "url": site_url + "venta_proceso/get_all_items",
            "type": "post",
        },
        'columns': [
            {data: 'id'},
            ...
            {data: 'monto_pagado', class: 'text-center'},
        ...
        "columnDefs": [
            ...
            },
            {
                ...
                render: function (data, type, row) {
                    if (row.nombre_cliente != 'ANULADO') {
                        if (row.estado != '2') {
                            return '<a  role="button"  onclick="anular_venta(this)" ><img width="30" height="30" src="' + base_url + '/assets/img/anular.png" title="Anular"></a>&nbsp;&nbsp;';
                        } else {
                            return '<label style="color: red;"><b>Esta anulado</b></label>';
                        }
                    }

...
$(document).ready(function () {
    ...
    $('#descuento_as').keyup(function () {
        ...
        //colocando el total para todas las formas y modos de pagos
        $('#monto_deposito').val(total.toFixed(2));
        $('#monto_cheque').val(total.toFixed(2));
        $('#monto_tarjeta').val(total.toFixed(2));
...
/*$('#descuento_producto').keyup(function () {
    var descuento = parseFloat($('#descuento_producto').val());
    var pv = parseFloat($('#id_pu').val());


    if (descuento > 0) {

        total_pv = pv - descuento;
        $('#precio_venta').val(total_pv.toFixed(2));
    }
    if (descuento <= 0) {
        $('#precio_venta').val(pv.toFixed(2));
    }

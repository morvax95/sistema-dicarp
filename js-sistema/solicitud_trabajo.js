...
$(document).ready(function () {
    ...
    $('#btn_registrar_nota').click(function (event) {
        ...
        $.ajax({
            url: site_url + 'solicitud_trabajo/registro_proforma',
            type: 'post',
            ...
            success: function (respuesta) {
                ...
                if (respuesta == false) {
                    ...
                    location.href = site_url + 'solicitud_trabajo';
                    mostrar_ventana(site_url + 'proforma/print_solicitud_trabajo/' + respuesta, 'Impresion', '700', '500');

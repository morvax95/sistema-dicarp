...
class Consultar_orden_trabajo_model extends CI_Model
{
    ...
    // Obtiene todas las ordenes de trabajo emitidas por sucursal
    public function get_all_orden_trabajo($params = array())
    {
        // Si se envia como parametro "draw", la peticion se esta realizando desde datatables
        if (!empty($this->input->post('draw'))) {

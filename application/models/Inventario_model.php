...
//        $data['materia'] = $this->db->get('inventario')->result();
    ...
    public function anular_inventario($id)
    {
        $this->db->trans_start();

        $this->db->where('ingreso_id', $id);
        $this->db->delete('producto_inventario');
    ...
    //endregion
    public function anular_inventario_segunda_parte($id)
    {
        $this->db->trans_start();

        $this->db->where('id', $id);
        $this->db->delete('ingreso_inventario');
    ...
    //endregion
    public function anular_inventario_tercera_parte($id)
    {
        $this->db->trans_start();

        $this->db->where('ingreso_id', $id);
        $this->db->delete('detalle_producto_ingreso');

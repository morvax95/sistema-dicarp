...
class Egreso_model extends CI_Model
{
    ...
    {
        $this->db->select("e.id, e.fecha_egreso, e.monto, s.sucursal, e.estado, t.descripcion as tipo_egreso, e.detalle as descripcion_egreso,u.nombre_usuario,e.forma_egreso");

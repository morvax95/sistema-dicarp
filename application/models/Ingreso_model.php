...
class Ingreso_model extends CI_Model
{
    ...
    {
        $this->db->select("e.id, e.fecha_ingreso, e.monto, s.sucursal, e.estado, t.descripcion as tipo_ingreso, t.descripcion");
        $this->db->from("ingreso_caja e, tipo_ingreso_egreso t, sucursal s");

...
class Solicitud_trabajo_model extends CI_Model
{
    ...
    public function registro_proforma()/* Registro como proforma  */
    {
        ...
        $obj_proforma['nota'] = $this->input->post('nota_proforma');
    ...
    {
        $this->db->select("v.id, v.fecha, v.hora, v.subtotal, v.descuento, v.total, u.nombre_usuario, v.nro_proforma, c.ci_nit, c.nombre_cliente, s.nit, s.nombre_empresa,s.sucursal, s.direccion, s.telefono, s.email,v.nota,v.descuento")
    ...
    {
        $this->db->select("v.id, sum(d.cantidad) as cantidad,d.precio_venta, t.descripcion as talla, c.descripcion as color, p.nombre_item,v.nota")

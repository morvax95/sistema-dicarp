    ...
    <div class="row">
        <form id="frm_registro_venta" class="form-horizontal" role="form" action="javascript: addRow1();">
            <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                <div class="box box-success">
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-file-archive-o fa-2x"></i> <b>SOLICITUD TRABAJO</b></h3>
                    </div>
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <span style="color:red">
                                    ...
                                    <b>
                                        <em>
                                            Los clientes que no esten registrados, se agregarán en la agenda automáticamente al registrar la orden de Trabajo.
                                        </em>
                                    </b>
                                </span>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <textarea id="nota_proforma" name="nota_proforma" class="form-control">
            ...
            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                <div class="box">
                    <div class="box-body">
                        <img src="http://localhost:8080/dicarp/assets/img/orden.jpg" width="250" height="195">
                    </div>
                </div>
...
<script type="text/javascript" src="<?= base_url('js-sistema/solicitud_trabajo.js') ?>"></script>
<script>
    var f = 0;
    var subtotal = 0;
    function addRow1() {

...
<div class="box-body">
    <div class="form-group">
        ...
        <div class="col-md-8">
            ...
            <span>
                <a style="color: red;" href="#modal_registro_tipo" data-toggle="modal" title="Agregar tipo egreso"><i
                            class="fa fa-plus-square"></i> Registrar nuevo tipo de egreso</a>
            </span>
        </div>
    </div>
    <div class="form-group">
        <label class="col-md-3 control-label text-right"><b>FORMA EGRESO </b></label>
        <div class="col-md-8">
            <select class="form-control" id="forma_egreso" name="forma_egreso">
    ...
    <div class="form-group">
        ...
        <div class="col-md-8">
            <input type="date" id="fecha_egreso" name="fecha_egreso" class="form-control"
                   value="<?= isset($egreso) ? $egreso->fecha_egreso : date('Y-m-d') ?>">
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-md-8">
            <input type="number" class="form-control" id="monto" name="monto"
                   value="<?= isset($egreso) ? $egreso->monto : '0.00' ?>"/>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-md-8">
            <textarea class="form-control" id="detalle" name="detalle"
                      placeholder="Escriba alguna observacion o detalle si tuviera"><?= isset($egreso) ? $egreso->detalle : '' ?></textarea>
        </div>
    </div>
</div>

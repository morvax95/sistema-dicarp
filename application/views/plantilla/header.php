...
//$idSucursal = $dato_sesion['id_sucursal'];
//$nombre_sucursal = $dato_sesion['sucursal'];
...
<div class="wrapper">
    <header class="main-header">
        ...
        <a href="<?= site_url('inicio') ?>" class="logo">
            ...
            <span class="logo-lg"><b>DICARP</b></span>
        </a>
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    <a href="<?= site_url('inicio') ?>">
                        ...
                        <small class="label pull-right bg-yellow">Home</small>
                    </a>
                </li>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <center><h5 class="panel-heading cabecera_frm bg-primary" style="color: white"><b>CIERRE DE
                                    SESIÓN</b></h5></center>
                    </div>
                                    ...
                                    <a href="<?= site_url('caja/cerrar_caja') ?>">
                                        <div class="info-box bg-green">
                                            ...
                                            <div class="info-box-content">
                                                ...
                                                <span class="info-box-text">Esta opcion cerrará la caja activa en ventas de esta sucursal.</span>
                                            </div>
                                        </div>
                                    </a>
                                </div>

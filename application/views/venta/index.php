                    ...
                    <div class="form-horizontal">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-12 col-xs-12">
                                    <a href="inventario/nuevo" id="id_producto_produccion"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <input type="text" id="id_color" name="id_color" placeholder="color"
                                                       hidden>
                                                <input type="text" id="id_pu" name="id_pu" placeholder="pu"
                                                       hidden>
                                            </td>
                                            ...
                                            <!-- <td>
                                                 <input type="number" id="descuento_producto" name="descuento_producto"
                                                        class="form-control" style="text-align: right" value="0.00"/>
                                             </td>-->
                                            <td>
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-12">
                                <!--Contenido-->
                                <!-- TIPO DE VENTA ,SUBTOTAL Y DESCUENTO -->
                                <div id="datos_venta" class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                    <div class="box">
                                        <div class="box-body">
                                            <div class="box-header with-border">
                                ...
                                <!-- FORMAS DE PAGO TERCERA PARTE -->
                                <div name="div_modo_pago" id="div_modo_pago"
                                     class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                    <label class="control-label" name="lbl_moneda" id="lbl_moneda"
                                           style="font-size: 14pt"><b>MONEDA:</b></label>
                                    <select name="tipo-moneda" id="tipo-moneda" required class="form-control"
                                            style="font-size: 14pt">
                                        <option value="1">Bs</option>
                                        <option value="2">$us</option>
                                    </select>
                                    <br>
                                    <div id="div-moneda" hidden>
                                        <div class="form-group">
                                            <label class="control-label" style="font-size: 14pt"><b>Tipo de cambio.</b></label>
                                            <input style="font-size: 14pt;" step="any" id="tipo-cambio"
                                                   name="tipo-cambio"
                                ...
                                <!--IMAGEN-->
                                <div id="imagen" class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                    <div class="box">

                                        <div class="box-body">
                                            <div class="image">
                                                <img src="<?= base_url('assets/img/forma_pago.png') ?>" width="250"
                                                     height="190"/>
                                            </div>

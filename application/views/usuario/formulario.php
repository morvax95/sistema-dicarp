        ...
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    ...
                    <a style="color: orange;" href="#modal_registro_rol" data-toggle="modal"><i
                                class="fa fa-plus-square"></i> Agregar una nuevo Cargo</a>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="box-footer text-center">
                <div class="col-sm-offset-2 col-sm-10">
                    <button id="boton_guardar_usuario" name="boton_guardar_usuario" type="submit"
                            class="btn btn-primary"><i class="fa fa-save"></i> Guardar
                    </button>

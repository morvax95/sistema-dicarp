        ...
        <div class="col-md-12">
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <!--inicio-->
                    <?php if ($user_data['cargo'] === '1' || $user_data['cargo'] === '2') { ?>
                        <?php
                        if (isset($ventas)) {
                    ...
                    <?php if ($user_data['cargo'] === '1' || $user_data['cargo'] === '2') { ?>
                        ...
                        if (isset($pagos)) {
                            ...
                            <div class="col-lg-4 col-md-6 col-xs-6">
                                <!--<div class="small-box  box-success box-solid">-->
                                <div class="small-box  box-success bg-green">
                                    <div class="inner">
                                        <!-- <h4> <?= $cantidad ?> <?= 'Deudas por Cobrar' ?></h4>-->
                                        <h4>  <?= 'Deudas por Cobrar' ?></h4>

...
<body onload="window.print().click()">
...
<div id="hoja" style="height: auto; width: auto">
    <table align="center">
        ...
        <tr>
            <td>
                <div align="center"><b>F A C T U R A<br>C O P I A </b></div>
            </td>
        </tr>
        <tr>
            <td>- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -</td>
    ...
    <table cellspacing="1" cellpadding="1" width="100%" style="font-size: 9pt;">
        ...
        foreach ($datos_venta_detalle as $row) {
            ...
            <tr>
                ...
                <td colspan="12"
                    style="padding-left: 5%; text-align: left"><?= ucwords(strtolower($descripcion)) ?></td>
            </tr>
            <tr>
                <td colspan="3"></td>
                <td colspan="4" style="text-align: center"><?= $cantidad ?></td>
                <td colspan="5" style="text-align: center"><?= $precio ?></td>
                <td colspan="6" style="text-align: right"><?php echo number_format($subtotal, 2); ?></td>
            </tr>
            <?php
        }
        ?>
    ...
    <table style="width: 100%" align="center">
        ...
        <tr>
            <td style="width:100%; font-size: 8pt; text-align: center">
                <b>"ESTA FACTURA CONTRIBUYE AL DESARROLLO DEL PAÍS. EL USO ILÍCITO DE ÉSTA SERÁ SANCIONADO DE ACUERDO A
                    LEY"</b>
            </td>
        </tr>
        <tr>

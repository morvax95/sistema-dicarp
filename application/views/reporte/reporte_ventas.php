        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title"><i class="fa fa-files-o fa-2x"></i> <b>REPORTE DE PRODUCTO TERMINADO</b>
                    </h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                    ...
                    <div class="panel panel-default" hidden>
                        <div class="panel-body">
                            <table class="table table-bordered" id="lista_reporte_ventas">
                                ...
                                <th class="text-center" style="width: 36%">PRODUCTO</th>
                                <th class="text-center" style="width: 16%">PRECIO UNITARIO</th>

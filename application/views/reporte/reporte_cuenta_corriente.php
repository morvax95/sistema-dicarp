        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title"><i class="fa fa-address-book-o fa-2x"></i> <b>REPORTE DE CUENTA CORRIENTE</b>
                    </h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                    <div class="alert alert-success alert-dismissible" style="font-size: 12pt">
                        <h4><i class="icon fa fa-info"></i> Aviso! Puede realizar búsquedas de un cuentas de un cliente.</h4>
                    </div>
                            ...
                            <div class="col-md-12">
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-1">
                                            <a class="btn btn-warning btn-sm" onclick="imprimir_cuenta_corriente()"
                                               href="" target="_blank"

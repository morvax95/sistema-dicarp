...
<section id="seccion" class="content">
    <div class="row">
        <form id="frm_registro_venta" class="form-horizontal" role="form" action="javascript: addRow1();">
            <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                <div class="box box-success">
                    <div class="box-header with-border">
                        <h2 class="box-title">VENTA DE PRODUCTOS </h2>
                        <div style="float:right">
                            <b style="font-size: 14pt">CAJA APERTURADA: </b><label id="caja_aperturada"
                                                                                   style="font-size: 14pt"></label>
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-xs-12">
                                <table id="lista_detalle" class="table table-bordered">
                                    <thead>
                                    <tr>
                                        <th class="text-center" style="width: 44%"><b>Producto</b></th>
            ...
            <!--                <div class="box">-->
            <!--                    <div class="box-body">-->
            <!--                        <label class="control-label" style="font-size: 14pt"><b>PAGO CON Bs.:</b></label>-->
            <!--                        <input type="number" step="any" id="efectivo_as" name="efectivo_as" value="0.00"-->
            <!--                               class="form-control"/>-->
            <!--                        <label class="control-label" style="font-size: 14pt"><b>CAMBIO Bs.:</b></label>-->
...
<div id="modal_set_caja" class="modal fade" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" style="color: black"><b>APERTURA DE CAJA</b></h5>
            </div>

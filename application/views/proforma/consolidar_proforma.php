            ...
            <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                <div class="box box-success">
                    <div class="box-header with-border">
                        <h2 class="box-title">CONSOLODAR PROFORMA</h2>
                        <div style="float:right">
                            <b class="label_title">CAJA APERTURADA: </b><label id="caja_aperturada" class="label_title"></label>
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <span class="class_span">
                                    ...
                                    <b>
                                        <em>
                                            Los clientes que no esten registrados, se agregaran en la agenda automaticamente al registrar la venta.
                                        </em>
                                    </b>
                                </span>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="col-lg-3 col-md-4 col-sm-12 col-xs-12">
                                    <a href="#modal_query_product" data-toggle="modal" id="search_product_btn"
                                       class="btn btn-primary btn-block"><i class="fa fa-search"></i>Consultar producto</a>
                                </div>
                            </div>
                            <hr>
                            <div class="col-xs-12">
                                <div class="table-responsive">
                                    <table id="lista_detalle" class="table table-bordered">
                                        <thead>
                                        <tr>
                                            <th class="text-center" style="width: 10%"><b>C. Barra</b></th>
                                            <th class="text-center" style="width: 30%"><b>Producto</b></th>
                                            <th class="text-center" style="width: 10%"><b>Talla</b></th>
                                            <th class="text-center" style="width: 10%"><b>Color</b></th>
                                            <th class="text-center" style="width: 10%"><b>Stock(Uni.)</b></th>
                                        ...
                                        <tr>
                                            <td>
                                                <input type="text" type="text"
                                                       class="form-control" id="codigo_barra_detalle" name="codigo_barra_detalle"
                                            ...
                                            <td>
                                                ...
                                                <select name="talla_venta" id="talla_venta" class="form-control" required>
                                                    <option value=""></option>
                                                </select>
                                            </td>
                                            <td>
                                                <!--<input type="text" id="color_venta" name="color_venta"
                                                       class="form-control" style="text-align: right" readonly/>-->
                                                <select name="color_venta" id="color_venta" class="form-control" required>
                                                    <option value=""></option>
                                                </select>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <input type="number" id="cantidad_venta" name="cantidad_venta" min="1" max=""
                                                       class="form-control"/>
                                            </td>
                                            <td></td>
                                            <td>
        ...
        <div class="modal-content">
            ...
            <form id="modal_registrar_cliente" action="<?= site_url('cliente/registrar_cliente') ?>" method="post"
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label class="col-sm-3 control-label">Cedula /Nit *</label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label">Trabajo</label>

                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="trabajo" name="trabajo" value=""
                                   placeholder="Escriba el lugar de trabajo">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">Talla de pantalon:</label>
                        <div class="col-sm-8">
                            <select name="talla_pantalon" id="talla_pantalon" class="form-control">
                                <?php
                                foreach ($tallas as $row) {
                                    ?>
                                    <option value="<?= $row->descripcion ?>" <?= isset($cliente) ? is_selected($cliente->talla_pantalon, $row->descripcion) : '' ?>><?= $row->descripcion ?></option>
                                    <?php
                                }
                                ?>
                            </select>
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label">Talla de camisa:</label>
                        <div class="col-sm-8">
                            <select name="talla_camisa" id="talla_camisa" class="form-control">
                                <?php
                                foreach ($tallas as $row) {
                                    ?>
                                    <option value="<?= $row->descripcion ?>" <?= isset($cliente) ? is_selected($cliente->talla_camisa, $row->descripcion) : '' ?>><?= $row->descripcion ?></option>
                                    <?php
                                }
                                ?>
                            </select>
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label">Talla de saco:</label>
                        <div class="col-sm-8">
                            <select name="talla_saco" id="talla_saco" class="form-control">
                                <?php
                                foreach ($tallas as $row) {
                                    ?>
                                    <option value="<?= $row->descripcion ?>" <?= isset($cliente) ? is_selected($cliente->talla_saco, $row->descripcion) : '' ?>><?= $row->descripcion ?></option>
                                    <?php
                                }
                                ?>
                            </select>
...
<div id="modal_query_product" class="modal fade" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title"><b>Consulta de productos</b></h4>
            </div>
            <form id="frm_search_product" action="<?= site_url('venta/consultar_producto') ?>" method="post"
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input type="number" class="form-control" id="product_code" name="product_code" value=""
                                   placeholder="Ingrese el codigo de barras del producto" required>
                        </div>
                        <div class="col-lg-2">

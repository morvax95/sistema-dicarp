...
<div class="box-body" xmlns="http://www.w3.org/1999/html" xmlns="http://www.w3.org/1999/html">
    ...
    <div class="col-md-6">
        ...
        <div class="form-group">
            <label class="col-md-3 control-label"><b>Cod. Interno*</b></label>
            <div class="col-md-7">
        ...
        <div class="form-group" hidden>
            <label class="col-md-3 control-label text-right"><b>Stock Minimo *</b></label>
            <div class="col-md-7">
    ...
    <div class="col-md-6">
        ...
        <div class="form-group">
            <label class="col-md-3 control-label text-right"><b>Categoria Inter.</b></label>
            <div class="col-md-7">
    ...
    <div class="col-lg-12">
        <div class="alert alert-success alert-dismissible">
            ...
            <marquee>Los campos con (*) son requidos, si su item no cuenta con codigo de barras colocar otro
                numero o dejar en blanco.
            </marquee>
        </div>
    </div>

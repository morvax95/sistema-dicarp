 ...
 * Time: 5:21 PM
 */
class Consultar_venta_anulada extends CI_Controller
{
    public function __construct()
    {
        parent::__construct();
        $this->load->model('consultar_venta_anulada_model', 'consulta');
        $this->load->model('venta_model', 'venta');
        $this->load->model('venta_proceso_model', 'venta_proceso');
    }

    public function index()
    {
        plantilla('consultar_venta_anulada/index', null);
    }

...
class Solicitud_trabajo extends CI_Controller
{
    public function __construct()
    {
        ...
        $this->load->model('solicitud_trabajo_model', 'solicitud_trabajo');
    }
    ...
    public function index()
    {
        ...
        plantilla('solicitud_trabajo/index', $data);
    }
    ...
    {
        if ($this->input->is_ajax_request()) {
            echo json_encode($this->solicitud_trabajo->registro_proforma());
        } else {
            show_404();
        }
    }

    ...
    public function buscar_item()
    {
        ...
        if ($res->num_rows() > 0) {
            foreach ($res->result_array() as $row) {
                ...
                $data[$row['nombre_item'] . "|" . $row['precio_venta'] . " Bs" . "|" . $row['descripcion']] = $row['id'] . "|" . $row['color_id'] . "|" . $row['talla_id'];
            }
...
//                        $data[$row['nombre_item'] . '|' . '|' . $row['color'] . "|" . $row['precio_venta'] . "|" . $row['cantidad'] . "|" . $row['cantidad_produccion'] . "|" . $row['codigo_barra']] = $row['producto_id'] . "|" . $row['id_talla'] . "|" . $row['id_color'];
                        $data[$row['nombre_item'] . '|' . '|' . $row['color'] . "|" . $row['precio_venta'] . "|" . $row['cantidad'] . "|" . $row['cantidad_produccion'] . "|" . $row['codigo_barra']. "|" . $row['precio_venta']] = $row['producto_id'] . "|" . $row['id_talla'] . "|" . $row['id_color'];

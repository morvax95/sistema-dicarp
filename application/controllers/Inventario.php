...
class Inventario extends CI_Controller
{
    ...
    public function anular_inventario()
    {
        if ($this->input->is_ajax_request()) {
            $id = $this->input->post('id');
            echo $this->inventario->anular_inventario($id);
            echo $this->inventario->anular_inventario_segunda_parte($id);
            echo $this->inventario->anular_inventario_tercera_parte($id);
